...
export default function EmailMe({ email }: { email: string }) {
  ...
  return (
    <div className="mt-10 bg-black rounded-full text-white font-mono py-3 px-6 mx-auto flex items-center gap-10">
      <span>{email}</span>
      <button className="text-white relative" onClick={handleCopy}>
        <svg
